...
import StreakScreen from '../screens/Home/StreakScreen/StreakWelcomeScreen';
    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          headerShown: false,
          tabBarIcon: ({focused}) =>
            focused ? <BottomIcon1 /> : <BottomIcon1W />,
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          headerShown: false,
          tabBarIcon: ({focused}) =>
            focused ? <BottomIcon2 /> : <BottomIcon2W />,
        }}
      />
      <Tab.Screen
        name="Affirmations"
        ...
        options={{
          headerShown: false,
          tabBarIcon: ({focused}) =>
            focused ? <BottomIcon3 /> : <BottomIcon3W />,
        }}
      />
      <Tab.Screen
        name="Team"
        ...
        options={{
          headerShown: false,
          tabBarIcon: ({focused}) =>
            focused ? <BottomIcon4 /> : <BottomIcon4W />,
        }}
      />
      <Tab.Screen
        name="Streak"
        ...
        options={{
          headerShown: false,
          tabBarIcon: ({focused}) =>
            focused ? <BottomIcon5 /> : <BottomIcon5W />,
        }}
      />
    </Tab.Navigator>
  );
