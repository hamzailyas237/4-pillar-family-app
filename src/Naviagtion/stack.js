...
import MyStreaks from '../screens/Home/StreakScreen/MyStreaks/index.jsx';
...
const StackNavigator = () => {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="PointPurchaseScreen"
        component={PointPurchaseScreen}
      />
      ...
      <Stack.Screen
        name="MyJournalsDrawerData"
        component={MyJournalsDrawerData}
      />
      <Stack.Screen
        name="MyJournalsDrawerEdit"
        component={MyJournalsDrawerEdit}
      />
      ...
      <Stack.Screen name="MyStreaks" component={MyStreaks} />
    </Stack.Navigator>
  );
};
