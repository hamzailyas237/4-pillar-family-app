      ...
      <View style={styles.mainContainer}>
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns1(true)}>
            <Text style={[styles.text, {color: rowBtns1 ? '#fff' : '#5D36FE'}]}>
              Faith
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns1 ? '#fff' : '#5D36FE'}]}>
                Pray or Meditate
              </Text>
        ...
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns2(true)}>
            ...
            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns2 ? '#fff' : '#5D36FE'}]}>
                Read Bible
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns2 ? (
      ...
      <View style={styles.mainContainer}>
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns3(true)}>
            <Text style={[styles.text, {color: rowBtns3 ? '#fff' : '#5D36FE'}]}>
              Family
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns3 ? '#fff' : '#5D36FE'}]}>
                Invest in marriage
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns3 ? (
        ...
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns4(true)}>
            <Text style={[styles.text, {color: rowBtns4 ? '#fff' : '#5D36FE'}]}>
              Family
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns4 ? '#fff' : '#5D36FE'}]}>
                Invest in family
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns4 ? (
      ...
      <View style={styles.mainContainer}>
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns5(true)}>
            <Text style={[styles.text, {color: rowBtns5 ? '#fff' : '#5D36FE'}]}>
              Fitness
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns5 ? '#fff' : '#5D36FE'}]}>
                Exercise
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns5 ? (
        ...
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns6(true)}>
            <Text style={[styles.text, {color: rowBtns6 ? '#fff' : '#5D36FE'}]}>
              Fitness
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns6 ? '#fff' : '#5D36FE'}]}>
                Morning Nutrition
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns6 ? (
      ...
      <View style={styles.mainContainer}>
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns7(true)}>
            <Text style={[styles.text, {color: rowBtns7 ? '#fff' : '#5D36FE'}]}>
              Education
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns7 ? '#fff' : '#5D36FE'}]}>
                Learn New
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns7 ? (
        ...
        <LinearGradient
          ...
          <TouchableOpacity onPress={() => setRowBtns8(true)}>
            <Text style={[styles.text, {color: rowBtns8 ? '#fff' : '#5D36FE'}]}>
              Goals
            </Text>

            <View style={styles.minContainer}>
              <Text
                style={[styles.tittle, {color: rowBtns8 ? '#fff' : '#5D36FE'}]}>
                Review & Grow
              </Text>
              <View style={styles.innerContainer}>
                {rowBtns8 ? (
