...
import { BAckICon, DimondIcon, DrawerIcon, FireICon, Help, Lock, LogOut, Message, QuestionMark, User,Doc  } from '../../assets/theme/svgimages';
...
const Header = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
           try {
             const response = await axios.get(`https://4-pillar-backend.vercel.app/api/v1/points/get-points/${id}`, {
                headers: {
...
<Image source={drawerIcon} style={styles.drawerIcon}/>                    
            ...
            <View style={{width:"96%", height:"40%",   backgroundColor: "#000",alignSelf:"center", borderRadius:8,
        borderWidth:1, borderColor:"#fff",
        }}>
          <View style={{backgroundColor:"#4EE681", width:56, height:56, borderRadius:50, justifyContent:"center", alignItems: 'center', alignSelf:"center", marginTop:24}}>
...
>
<Text style={{textAlign:"center", color:"#E2E2E2", fontFamily:"Now-Medium-BF6542f7137648d", fontSize:18}}>Confirm</Text>
</LinearGradient>
</TouchableOpacity>
...
<Text style={{textAlign:"center", color:"#E2E2E2", fontFamily:"Now-Medium-BF6542f7137648d", fontSize:18}}>Cancel</Text>
</TouchableOpacity>
            </View>
            </View>
            ...
            >
            <View style={[styles.modalContainer, {width: windowWidth *0.7, height:windowHeight}]}>
            <View style={[styles.modalInnerContainer, {width: windowWidth *0.7, height:windowHeight}]}>
...
<TouchableOpacity style={styles.modalBtn} onPress={()=>navigation.navigate("MyProfile")}>
<User />
<Text style={styles.modalBtnText}>Profile</Text>
</TouchableOpacity>

<TouchableOpacity style={styles.modalBtn} onPress={()=> navigation.navigate("MyJournalsDrawer")}>
<Doc /> 
<Text style={styles.modalBtnText}>My Journals</Text>
</TouchableOpacity>

<TouchableOpacity style={styles.modalBtn} onPress={()=> navigation.navigate("ResetPassword")}>
<Lock /> 
<Text style={styles.modalBtnText}>Reset Password</Text>
</TouchableOpacity>

<TouchableOpacity style={styles.modalBtn} onPress={()=> navigation.navigate("EmailSupportDrawer")}>
<Message /> 
<Text style={styles.modalBtnText}>Email Support</Text>
</TouchableOpacity>

<TouchableOpacity style={styles.modalBtn} onPress={()=> navigation.navigate("HelpScreen")}>
<QuestionMark /> 
