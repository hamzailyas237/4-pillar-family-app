...
export const loginUser = createAsyncThunk(
  ...
  async ({ email, password,navigation,  }, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch("https://4-pillar-backend.vercel.app/api/v1/users/login ", {
        method: 'POST',
...
export const loginUserChild = createAsyncThunk(
  ...
  async ({ email, password,navigation  }, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch("https://4-pillar-backend.vercel.app/api/v1/users/children-login ", {
        method: 'POST',
        body: JSON.stringify({ email,  password }),
        ...config,
        // token,
...
export const signupUser = createAsyncThunk(
  'users/signup',
  async ({ firstName, lastName, email, dob, password, role, scoringLevel, navigation }, { rejectWithValue }) => {
    //  console.log("SignupApi", firstName, lastName, email, dob, password, role, scoringLevel);
     ...
     const response = await fetch("https://4-pillar-backend.vercel.app/api/v1/users/signup", {
       method: 'POST',
       body: JSON.stringify({ firstName, lastName, email, dob, password, role, scoringLevel }),
       ...config,
     });
...
try {
  const response = await fetch("https://4-pillar-backend.vercel.app/api/v1/users/forgotPassword", {
    method: 'POST',
...
try {
  const response = await fetch("https://4-pillar-backend.vercel.app/api/v1/users/verify-forgot-password-otp", {
    method: 'POST',
...
try {
  const response = await fetch("https://4-pillar-backend.vercel.app/api/v1/users/resetPasswordDone", {
    method: 'POST',
...
export const writeGrtitude = createAsyncThunk(
  ...
  async ({ gratitudeInput1, gratitudeInput2,gratitudeInput3, userId, navigation,  }, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/gratitude/write-gratitude', {
        method: 'POST',
        body: JSON.stringify({ gratitudeInput1, gratitudeInput2,gratitudeInput3, userId }),
        ...config,
      });
...
export const writeJournals = createAsyncThunk(
  ...
  async ({userId, journalType, freeFlow  }, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/journal/write-journal', {
        method: 'POST',
...
export const inviteteamMember = createAsyncThunk(
  ...
  async ({userId, email ,navigation}, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/users/children-invitaion', {
        method: 'POST',
...
export const emailsupportDrawer = createAsyncThunk(
  ...
  async ({email, message, firstName, lastName, role ,navigation}, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/help-and-support/supportMessage', {
        method: 'POST',
...
export const resetPassword = createAsyncThunk(
  ...
  async ({passwordCurrent, password, passwordConfirm,token,  navigation}, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/users/updateMyPassword', {
        method: 'PATCH',
...
export const helpMessage = createAsyncThunk(
  ...
  async ({email, message, firstName, lastName, role ,navigation}, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/help-and-support/helpMessage', {
        method: 'POST',
        body: JSON.stringify({ email, message, firstName, lastName, role  }),
        ...config,
      });
...
export const updateProfile = createAsyncThunk(
  ...
  async ({firstName, lastName, dob, token}, { rejectWithValue }) => {
    ...
    const config = {
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/users/updateMe', {
        method: 'PATCH',
...
export const rowBtns = createAsyncThunk(
  'points/add-points',
  async ({ userId, token, faith1, faith2, family1, family2, fitness1, fitness2, education, goals }, { rejectWithValue }) => {
    console.log('email,ReduexFile============================>',userId, token, faith1, faith2, family1, family2, fitness1, fitness2, education, goals);
    const config = {
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
      ...
      const response = await fetch('https://4-pillar-backend.vercel.app/api/v1/points/add-points', {
        method: 'POST',
        body: JSON.stringify({userId,  faith1, faith2, family1, family2, fitness1, fitness2, education, goals }),
        ...config,
      });
