import { Text, View, SafeAreaView, ImageBackground, Image, TouchableOpacity, Alert, ActivityIndicator, TextInput  } from 'react-native'
...
<Text style={{fontFamily:"Now-Medium-BF6542f7137648d", color:"#fff",  fontSize:17}}>Sign Up</Text>
</TouchableOpacity>
}
...
<TouchableOpacity onPress={onsubmitChild}
style={{marginTop:26}}
>
...
style={styles.linear}
>
<Text style={{textAlign:"center", color:"#FFFFFF", fontFamily:"Now-Medium-BF6542f7137648d", fontSize:18}}>Login</Text>
</LinearGradient>
</TouchableOpacity>
}
