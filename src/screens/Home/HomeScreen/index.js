...
const HomeScreen = () => {
    ...
    const [gratitudeInput1, setGratitudeInput1] = useState(writeGratitude?.gratitudeInput1 || '');
    ...
    useEffect(() => {
        if (
            rowBtnsValues.faith1 === true && rowBtnsValues.faith2 === true &&
            rowBtnsValues.family1 === true && rowBtnsValues.family2 === true &&
            rowBtnsValues.fitness1 === true && rowBtnsValues.fitness2 === true &&
            rowBtnsValues.education === true && rowBtnsValues.goals === true
        ) {
            dispatch(rowBtns(rowBtnsValues));
        }
                ...
                <ScrollView
                    ...
                    <View style={styles.container}>
                        <TouchableOpacity
                            ...
                            <Text style={styles.purchasePointBtnText}>
                                PURCHASE POINTS
                            </Text>
                        ...
                        {userRole?.role === 'child' ?
                            <TouchableOpacity style={styles.childUnlockBtn}>
                                ...
                                <Text style={styles.childUnlockBtnText}>Unlock your rewards</Text>
                                <Text style={[styles.childUnlockBtnText, { fontFamily: "Now-Regular-BF6542f7138c477", }]}>2 remainings</Text>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <Text style={[styles.text2, { marginLeft: 8, marginTop: 8 }]}>Write Gratitude & Journal {"\n"}& Get Points</Text>
                            <Image source={daimondImg} style={styles.daimondImg} resizeMode="contain" />
                        </View>


                        <View style={{ flexDirection: "row", alignItems: "center", }}>
                            {writeGratitude && (writeGratitude.gratitudeInput1 || writeGratitude.gratitudeInput2 || writeGratitude.gratitudeInput3) ? (
                                <LinearGradient
                                    colors={["#BA5DFE", "#5D36FE"]}
                                    start={{ x: 0.2, y: 0.25 }} end={{ x: 0.9, y: 2.0 }}
                                    style={{
                                        width: 155, height: 56, margin: 5,
                                        borderRadius: 5,
                                    }}
                                >
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate("WriteGratitude")}
                                        style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-around", flex: 0.9 }}>
                                        <Text style={{
                                            fontFamily: "Now-Medium-BF6542f7137648d", fontSize: 19,
                                            // marginLeft:12, 
                                            marginTop: 6,
                                            color: "#fff",
                                            fontWeight: "600",
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ backgroundColor: "#fff", width: 20, height: 20, justifyContent: "center", alignItems: "center", borderRadius: 4, }}>
                                ...
                                <ImageBackground
                                    source={homeBtnImg}
                                    style={styles.homeBtnImg}

                                >


                                    <TouchableOpacity onPress={() => navigation.navigate("WriteGratitude")}
                                        style={{ borderWidth: 2, borderColor: "#fff", borderRadius: 8, paddingVertical: 16 }}
                                    >
                            ...
                            <ImageBackground source={homeBtnImg2}
                                style={[styles.homeBtnImg, {
                                    width: 158,
                                    height: 54,
                                }]}
                        ...
                        <Text style={[styles.headtext, { marginTop: 12, marginLeft: 0 }]}> POINTS THIS WEEK</Text>
                        ...
                        <Text style={{ marginHorizontal: 8, color: "#fff", fontFamily: "Now-Regular-BF6542f7138c477", fontSize: 16 }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget justo ac velit rhoncus tempor sit amet nec turpis.  </Text>


                        <LinearGradient colors={["#9B50FE", "#fff"]}
                            start={{ x: 0.8, y: 0.0 }} end={{ x: 0.9, y: 1.0 }}
                            style={{ width: "96%", height: 10, borderRadius: 16, alignSelf: "center", marginTop: 16 }}
                        />
                        ...
                        <View style={styles.textView}>
                            <Text style={[styles.headtext,]}>
                                AFFIRMATIONS</Text>
                            <Text onPress={() => navigation.navigate('Affirmations')} style={[styles.seealltext,]}>
                                See All</Text>
                        </View>

                        <View style={{ marginTop: 5 }} />
                        <Text style={[styles.text2, { marginLeft: 6 }]}>Complete all afirmations & get{"\n"}1point</Text>
                        <View style={styles.radioBtnContainer} >

                            <TouchableOpacity style={styles.radioBtnInnerContainer}>
                        ...
                        <View style={styles.textView}>
                            <Text style={[{ color: Colors.text.secondary, fontSize: 19, marginLeft: 6, marginBottom: 6, fontFamily: "Now-Regular-BF6542f7138c477", }]}>
                                Completed</Text>
                        </View>
                        ...
                        <View style={{ marginTop: 10, }} >
                            <Text style={[styles.text, { fontSize: Fonts.size.large, color: Colors.text.tertiary, marginLeft: 10 }]}>
                                PURPOSE</Text>
                        </View>
                        <View style={[styles.textView, { marginBottom: 16 }]}>
                            <Text style={[styles.text, { fontSize: 18, color: Colors.text.tertiary, marginLeft: 10 }]}>
                                Daily Habits</Text>
                            <Text
                        ...
                        <Text style={[{ color: Colors.text.secondary, fontSize: 19, marginLeft: 6, fontFamily: "Now-Regular-BF6542f7138c477", marginVertical: 16 }]}>
                            Completed</Text>
