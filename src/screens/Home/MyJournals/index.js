...
import { writeJournals, writeJournalsDevotional, writeJournalsReframe } from '../../../redux/slices';
            ...
            <ImageBackground
                ...
                <KeyboardAwareScrollView
                    ...
                    <View style={styles.container}>
                        ...
                        <LinearGradient colors={selectedOption === 0 ? ["#BA5DFE", "#5D36FE"] :  ['rgba(67, 59, 115, 255)', 'rgba(67, 59, 115, 255)']}
                        start={{ x:  0.1, y:  0.1 }}
                         end={{ x:  0.9, y:  0.9 }}
                        ...
                        <Text  style={{ fontFamily:"Now-Medium-BF6542f7137648d", fontSize:18, color:"#fff"}}>
                            Free Flow
                            </Text>
                        ...
                        <LinearGradient colors={selectedOption === 2 ? ["#BA5DFE", "#5D36FE"] :  ['rgba(67, 59, 115, 255)', 'rgba(67, 59, 115, 255)']}
                        start={{ x:  0.1, y:  0.1 }}
                        end={{ x:  0.9, y:  0.9 }}
                        style={[styles.btntext]}
                        >
                        ...
                        <LinearGradient 
                        colors={selectedOption === 3 ? ["#BA5DFE", "#5D36FE"]
                   ...
                   
{
    ...
    <TextInput style={styles.hideContainer}
    value={freeFlow}
...
<>
<Text style={styles.inputsHeading}>Lorem ipsum dolor sit amet, ?</Text>
...

{
    ...
    <TouchableOpacity onPress={()=> onsubmit( { type: "devotional"})}>
<LinearGradient colors={["#BA5DFE", "#5D36FE"]}
start={{x: 0.2, y: 0.25}} end={{x: 0.9, y: 2.0}}
style={styles.linear}
>
