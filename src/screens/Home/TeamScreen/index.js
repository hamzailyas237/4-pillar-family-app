            ...
            <ImageBackground
                ...
                <ScrollView
                    ...
                    <View style={styles.container}>
                        <Text style={[styles.text, { fontSize: Fonts.size.medium,marginTop:12 }]}>Invite Team Member</Text>
                     
                        <TouchableOpacity  
                        onPress={()=> navigation.navigate("CreateKids")}
                        >
                        <LinearGradient colors={["#BA5DFE", "#5D36FE"]}
                        start={{x: 0.2, y: 0.25}} end={{x: 0.9, y: 2.0}}
                        style={styles.linear}
                        >
                       <Text style={{textAlign:"center", color:"#FFFFFF", fontFamily:"Now-Medium-BF6542f7137648d", fontSize:18}}>Create Kids accounts</Text>
                        </LinearGradient>
                        </TouchableOpacity>
...
<Text style={{textAlign:"center", color:"#FFFFFF", fontFamily:"Now-Medium-BF6542f7137648d", fontSize:18}}>Buy Points</Text>

</TouchableOpacity>


                        <Text style={[styles.text, { fontSize: Fonts.size.medium,marginBottom:12 }]}>My Team</Text>
                        <>
